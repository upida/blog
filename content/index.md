...
projects:
  ...
  items:
    - title: "Chatbot Platform"
      description: "AI-powered chatbot platform with LLM integration"
      tech: ["Python", "FastAPI", "Vue.js"]
      link: "https://github.com/upida"
...
faq:
  ...
  description: "Answers to common questions about my work and expertise."
  categories:
    ...
    - title: "Pricing & Timelines"
      questions:
        - label: "What are your rates?"
          content: "My rates vary based on project scope and complexity. For custom quotes, I typically charge hourly rates starting at competitive market rates, or we can discuss fixed-price project arrangements. Please reach out via email or LinkedIn to discuss your specific project and get a detailed estimate."
        - label: "What are your payment terms?"
          content: "For larger projects, I typically require a 40% deposit to begin work, with the remaining balance due upon completion. For hourly work, I invoice weekly or bi-weekly depending on the arrangement. I accept bank transfers and online payment methods."
        - label: "How long does a typical project take?"
          content: "Timeline depends on project scope and complexity. Small projects or features can take 1-2 weeks, medium projects typically 4-8 weeks, and larger applications can take 2-4 months or more. I provide detailed timeline estimates after an initial consultation."
...
This file contains all the portfolio data structured as frontmatter.
